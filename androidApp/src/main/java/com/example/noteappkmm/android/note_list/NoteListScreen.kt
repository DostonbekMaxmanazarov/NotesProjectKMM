...
import com.example.noteappkmm.android.vm.NoteListViewModel
...
fun NoteListScreen(
    ...
    val gradientGreenRed = Brush.verticalGradient(0f to Color.Magenta, 1000f to Color.Red)
    ...
    Scaffold(floatingActionButton = {
        FloatingActionButton(
            onClick = {
                navController.navigate("noteDetail/-1L")
        ...
        Column(
            ...
            Box(
                ...
                HideAbleSearchTextField(
                    ...
                    onSearchClick = viewModel::onSelectedToggleSearch,
                    onCloseClick = viewModel::onSelectedToggleSearch,
                    modifier = Modifier
                        .fillMaxWidth()
                        .height(90.dp)
                )
